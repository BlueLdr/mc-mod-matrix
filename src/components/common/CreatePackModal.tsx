...
import { LoaderIcons, Modal } from "~/components";
...
export function CreatePackModal() {
  ...
  const onSubmit = (e: React.FormEvent) => {
    ...
    addPack(formData);
    navigate(`/${encodeURIComponent(formData.name)}`);
    setOpen(false);
  };
